...
class ImageUploadBottomSheet(private val pictureCount: Int,private val onPhotoSelected     : (List<String>) -> Unit) : BottomSheetDialogFragment(){
    ...
    private var pickMultipleVisualMediaResultLauncher : ActivityResultLauncher<PickVisualMediaRequest> = registerForActivityResult(ActivityResultContracts.PickMultipleVisualMedia()){ uris ->
