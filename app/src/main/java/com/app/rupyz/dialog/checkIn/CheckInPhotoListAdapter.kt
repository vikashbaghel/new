...
import com.app.rupyz.databinding.ItemAddPhotoCheckInListBinding
import com.app.rupyz.generic.utils.AppConstant
import com.app.rupyz.generic.utils.ImageUtils
import com.app.rupyz.model_kt.AddedPhotoModel
import java.io.File

class CheckInPhotoListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if (viewType == viewTypeItem) {
            val itemView = LayoutInflater.from(parent.context)
                .inflate(R.layout.item_add_photo__check_in_list, parent, false)
            return MyViewHolder(itemView)
        } else {
            val view: View = LayoutInflater.from(parent.context)
                .inflate(R.layout.item_add_image_check_in, parent, false)
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val binding = ItemAddPhotoCheckInListBinding.bind(itemView)
        fun bindItem(
