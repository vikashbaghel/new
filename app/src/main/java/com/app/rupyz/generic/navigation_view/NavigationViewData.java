...
public class NavigationViewData {
    ...
    public List<NavigationViewModel> getNavigationData() {
        List<NavigationViewModel> mData = new ArrayList<>();
        NavigationViewModel profile = new NavigationViewModel();
        profile.setName("Profile");
        profile.setImageId(R.drawable.ic_user_profile);
        mData.add(profile);

        NavigationViewModel pictureGallery = new NavigationViewModel();
        pictureGallery.setName("Picture Gallery");
        pictureGallery.setImageId(R.mipmap.gallery_thumbnail);
        mData.add(pictureGallery);
