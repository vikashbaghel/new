...
public class ProductDetailInfoModel implements Serializable {
    ...
    private String category, variant_name;
    private int min_price, max_price;
    private List<Integer> pics;
    private String description, mrp_unit, avaliable_stock, unit, name, code, nanoid, packaging_unit, hsn_code, brand,string;
    private Boolean is_published, gst_exclusive, is_out_of_stock;
    private int view_count, like_count, organization, created_by;
    private Integer display_pic, primary_product;
    private Double gst, packaging_size, qty;
    private double price, mrp_price;
    private List<PicMapModel> pics_map;
    private ArrayList<PackagingLevelModel> packaging_level;
    private ArrayList<TelescopicPricingModel> telescope_pricing;
    ...
    private PackagingLevelModel selectedPackagingLevel = null;
    ...
    private ArrayList<VariantsItem> variants;

    private ArrayList<VariantDataInfoItem> variants_data;
    ...
    public ArrayList<VariantsItem> getVariants() {
        return variants;
    }

    public void setVariants(ArrayList<VariantsItem> variants) {
        this.variants = variants;
    }

    public ArrayList<VariantDataInfoItem> getVariant_data() {
        return variants_data;
    }

    public void setVariant_data(ArrayList<VariantDataInfoItem> variants_data) {
    ...
    public Integer getPrimary_product() {
        return primary_product;
    }

    public void setPrimary_product(Integer primary_product) {
        this.primary_product = primary_product;
    }

    public ArrayList<TelescopicPricingModel> getTelescope_pricing() {
        return telescope_pricing;
    }

    public void setTelescope_pricing(ArrayList<TelescopicPricingModel> telescope_pricing) {
        this.telescope_pricing = telescope_pricing;
    }
