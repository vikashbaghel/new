...
public class TradelinesItem{
	...
	private List<History48MonthsItem> history48Months;
	...
	public void setHistory48Months(List<History48MonthsItem> history48Months){
		this.history48Months = history48Months;
	}

	public List<History48MonthsItem> getHistory48Months(){
