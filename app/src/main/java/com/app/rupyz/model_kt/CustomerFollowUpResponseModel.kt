...
data class CustomerFollowUpDataItem(
    ...
    @field:SerializedName("start_day_geo_address")
    var startDayGeoAddress: String? = null,

    @field:SerializedName("end_day_geo_address")
    var endDayGeoAddress: String? = null,
    ...
    @field:SerializedName("start_day_geo_location_long")
    var startDayGeoLocationLong: Double? = 0.0,

    @field:SerializedName("end_day_geo_location_long")
    var endDayGeoLocationLong: Double? = 0.0,
    ...
    @field:SerializedName("start_day_geo_location_lat")
    var startDayGeoLocationLat: Double? = 0.0,

    @field:SerializedName("end_day_geo_location_lat")
    var endDayGeoLocationLat: Double? = 0.0,
