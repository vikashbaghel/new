...
interface ApiInterface {
    ...
    @Headers("Content-Type: application/json;charset=UTF-8")
    @GET("organization/{org_id}/product/es/")
    ...
    fun getDashboardData(
            @Path("org_id") org_id: Int,
            @Query("for_dump") forDumpTrue: Boolean
    ...
    fun getOrderList(
            ...
            @Query("fullfilled_by_ids") full_filled_by_ids: Int?,
            @Query("customer_level") customer_level: String,
            @Query("page_no") page_no: Int,
            @Query("page_size") pageSize: Int?,
            @Query("for_dump") forDump: Boolean?,
    ...
    fun updatePreferences(
            @Path("org_id") org_id: Int,
            @Body updatePreferencesModel: PreferenceData
    ...
    fun setUserPreferencesInfo(
            @Path("org_id") org_id: Int,
            @Body jsonObject: UserPreferenceData
    ): Call<UserPreferencesResponseModel>
    ...
    fun getPricingGroupList(
            @Path("org_id") org_id: Int,
            @Query("is_with_id") is_with_id: Boolean
    ...
    fun getStaffTrackingDetails(
            ...
            @Query("user_id") staff_id: Int?
    ): Call<StaffTrackingDetailsResponseModel>

    @Headers("Content-Type: application/json;charset=UTF-8")
    @GET("/v2/organization/{org_id}/activity/logs/team/")
    ...
    fun addTotalExpenseTracker(
            @Path("org_id") org_id: Int,
            @Body model: ExpenseTrackerDataItem
    ): Call<AddTotalExpenseResponseModel>
    ...
    @Headers("Content-Type: application/json;charset=UTF-8")
    @POST("/v1/user/logout/")
    fun logout(): Call<GenericResponseModel>
    ...
    fun getAttendanceDetails(
            @Path("org_id") org_id: Int,
            @Path("attendance_id") attendance_id: Int): Call<CustomerFollowUpSingleResponseModel>

    @Headers("Content-Type: application/json;charset=UTF-8")
    @GET("/v2/organization/{org_id}/custom-forms/activity/{activity_type_id}/")
    fun getCustomFormInputList(
            @Path("org_id") orgId: Int,
            @Path("activity_type_id") id: Int
