...
class DatabaseLogManager {
    ...
    fun addOfflineActivity(
        liveData: MutableLiveData<CustomerFollowUpResponseModel>?,
        feedbackModel: CustomerFollowUpDataItem
    ) {
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
    ...
    fun addOfflineAttendance(
        ...
        feedbackModel: AddCheckInOutModel
    ) {
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                ...
                if (customerId != null &&
                    ...
                    if (category.isEmpty()) {
                        ...
                        if (customer.isNotEmpty()) {
                            val categoryListAssignToCustomer: List<Int?> =
                                customer[0].productCategory
                                    ?: ArrayList()

                            if (categoryListAssignToCustomer.isNotEmpty()) {
                                val categoryList = database!!.productDao()
                                    .getCategoryData(name) as ArrayList<AllCategoryResponseModel>

                                val filterCategoryList =
                                    categoryList.filter { it.id in categoryListAssignToCustomer }
                ...
                model.data = if (applyFilterForCategory) {
                    database!!.productDao().getProductDataWIthCategoryMapping(
                        name, stringBuilder.toString(),
                        filterCategory, pageSize, offset
                    ) as ArrayList<ProductList>
                } else {
                    database!!.productDao().getProductData(
                        name, stringBuilder.toString(),
    ...
    fun getBrandListData(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                ...
                model.error = false
                model.data = database!!.productDao()
                    .getBrandData(name, pageSize, offset) as ArrayList<BrandDataItem>
                ...
                if (customerId != null && customerId != 0) {
                    ...
                    if (customer.isNotEmpty()) {
                        ...
                        val filterCategoryList =
                            categoryList.filter { it.id in categoryListAssignToCustomer }
                        model.data =
                            filterCategoryList as java.util.ArrayList<AllCategoryResponseModel>?
                    }
                } else {
    ...
    fun getProductCategoryListAssignToCustomer(
        categoryLiveData: MutableLiveData<AllCategoryInfoModel>,
        customerId: Int?,
        name: String
    ) {
    ...
    fun getOfflineCustomerList(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            val queryString =
                "SELECT * FROM customer_table WHERE name LIKE '%' || '$name' || '%' AND customerLevel LIKE '%' || '$customerLevel' || '%' AND (customerParent = $customerParentID OR $customerParentID IS NULL) AND ('$filter' IS NULL OR '$filter' = '' OR customer_type IN ('$filter')) ORDER BY $sortBy COLLATE NOCASE $sortingOrder LIMIT $pageSize OFFSET $offset"
            ...
            if (database != null) {
                ...
                customerList.addAll(
                    database!!.customerDao().getCustomerData(query) as ArrayList<CustomerData>
                )
    ...
    fun getOfflineCustomerTypeList(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                ...
                model.error = false
                model.data = database!!.customerDao().getCustomerTypeData(
                    name,
                    currentPage,
                    pageSize
                ) as ArrayList<CustomerTypeDataItem>
    ...
    fun getOfflineOrderList(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                ...
                model.error = false
                model.data = database!!.orderDao().getOrderList(
                    status,
                    fullFilledById,
                    customerLevel,
                    pageSize,
                    offset
                ) as ArrayList<OrderData>
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                ...
                database!!.dashboardDao()
                    .updateDashboardData(getUpdateDashboardQuery("orders", AppConstant.MINUS_COUNT))
    ...
    fun getOfflineCustomerOrderListById(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                val model = OrderInfoModel()
                model.error = false
                val orderList = database!!.orderDao().getOrderListWithCustomerMapping(
                    customerId,
                    pageSize,
                    offset
                ) as ArrayList<OrderData>
    ...
    fun getOfflinePaymentList(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                ...
                model.error = false
                model.data = database!!.paymentDao()
                    .getPaymentList(status, pageSize, offset) as ArrayList<RecordPaymentData>
    ...
    fun getAddressListForCustomer(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                ...
                model.error = false
                model.data = database!!.customerDao()
                    .getAddressListForCustomer(customerId) as ArrayList<CustomerAddressDataItem>
    ...
    fun addAddressForOfflineCustomer(
        liveData: MutableLiveData<CustomerAddressApiResponseModel>,
        address: CustomerAddressDataItem
    ) {
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
    ...
    fun getOfflineStaffList(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                ...
                model.error = false
                val staffList = database!!.staffDao()
                    .getStaffList(name, pageSize, offset) as ArrayList<StaffData>

                if (role?.isNotEmpty() == true) {
                    val filterStaffList = ArrayList<StaffData>()
                    staffList.forEach { staffData ->
                        if (staffData.roles.isNullOrEmpty()
                                .not() && staffData.roles!!.contains(role)
                        ) {
    ...
    fun getOfflineStaffListForAddCustomer(
    ...
    fun getStaffRoles(liveData: MutableLiveData<AssignRolesResponseModel>, page: Int) {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                ...
                model.error = false
                model.data = database!!.staffDao()
                    .getStaffRolesList(pageSize, offset) as ArrayList<AssignedRoleItem>
    ...
    fun getLeadCategoryList(liveData: MutableLiveData<LeadCategoryListResponseModel>) {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                ...
                model.error = false
                model.data =
                    database!!.leadDao().getLeadCategoryList() as ArrayList<LeadCategoryDataItem>
    ...
    fun getOfflineLeadList(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                ...
                model.error = false
                model.data = database!!.leadDao()
                    .getLeadList(name, category, pageSize, offset) as ArrayList<LeadLisDataItem>
    ...
    fun getOfflineTotalExpenseList(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                ...
                model.error = false
                model.data = database!!.expenseDao().getExpenseHeadList(
                    filterStatus,
                    pageSize,
                    offset
    ...
    fun getOfflineExpenseList(liveData: MutableLiveData<ExpenseResponseModel>, rtId: Int) {
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                ...
                model.error = false
                model.data =
                    database!!.expenseDao().getExpenseList(rtId) as ArrayList<ExpenseDataItem>
    ...
    fun getOfflineExpenseHeadDetails(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                ...
                model.error = false
                val details = database!!.expenseDao()
                    .getExpenseHeadDetail(rtId) as ArrayList<ExpenseTrackerDataItem>
    ...
    fun getOfflineExpenseDetails(liveData: MutableLiveData<AddExpenseResponseModel>, remId: Int) {
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                ...
                model.error = false
                val details =
                    database!!.expenseDao().getExpenseDetail(remId) as ArrayList<ExpenseDataItem>
    ...
    fun getOfflineOrderDispatchedDetails(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                ...
                model.error = false
                if (database!!.orderDao().getOrderDispatchDetailsById(orderId, dispatchId).isEmpty()
                        .not()
                ) {
                    model.data =
                        database!!.orderDao().getOrderDispatchDetailsById(orderId, dispatchId)[0]
                }
    ...
    fun addOrderToDatabase(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                ...
                database!!.dashboardDao()
                    .updateDashboardData(getUpdateDashboardQuery("orders", AppConstant.ADD_COUNT))
            }
    ...
    fun updateOfflineOrder(liveData: MutableLiveData<OrderDetailsInfoModel>, model: OrderData?) {
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                model?.let { database!!.orderDao().updateOrder(it) }
            }
    ...
    fun saveOfflineCustomer(
        liveData: MutableLiveData<CustomerAddResponseModel>,
        addCustomerModel: CustomerData
    ) {
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                database!!.customerDao().saveOfflineCustomer(addCustomerModel)
                database!!.dashboardDao().updateDashboardData(
                    getUpdateDashboardQuery(
                        "customers",
                        AppConstant.ADD_COUNT
                    )
                )
            }
    ...
    fun createOfflineLead(
        liveData: MutableLiveData<AddLeadResponseModel>,
        jsonObject: LeadLisDataItem
    ) {
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
    ...
    fun addOfflinePaymentData(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                ...
                database!!.dashboardDao()
                    .updateDashboardData(getUpdateDashboardQuery("payment", AppConstant.ADD_COUNT))
            }
    ...
    fun getOfflinePaymentDetails(liveData: MutableLiveData<RecordPaymentDetailModel>, id: Int) {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            addResponseModel.error = false
            if (database != null && database!!.paymentDao().getOfflinePaymentDetails(id)
                    .isNotEmpty()
            ) {
    ...
    fun addOfflineExpense(
        liveData: MutableLiveData<AddExpenseResponseModel>,
        model: ExpenseDataItem
    ) {
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
    ...
    fun updateOfflineExpense(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (database != null) {
                val remList = database!!.expenseDao()
                    .getExpenseDetail(model.id!!) as ArrayList<ExpenseDataItem>
                ...
                database!!.expenseDao()
                    .updateExpenseHeadAmount(model.reimbursementtracker, totalAmountToAdd)
            }
    ...
    fun deleteOfflineExpense(
        liveData: MutableLiveData<AddExpenseResponseModel>,
        remData: ExpenseDataItem
    ) {
        CoroutineScope(Dispatchers.IO).launch {
            var totalAmountToAdd: Double? = 0.0
            if (database != null) {
                ...
                val rtList =
                    database!!.expenseDao().getExpenseHeadDetail(remData.reimbursementtracker!!)
                            as ArrayList<ExpenseTrackerDataItem>
                if (rtList.isNotEmpty()) {
                    ...
                    database!!.expenseDao()
                        .updateExpenseHead(remData.reimbursementtracker, totalAmountToAdd, -1)
                ...
                try {
                    ...
                    customerList.addAll(
                        database!!.customerDao()
                            .getCustomerNotSyncedData() as ArrayList<CustomerData>
                    )
                    model.data = customerList
                    model.error = false
                    liveData.postValue(model)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                try {
                    ...
                    list.addAll(
                        database!!.leadDao().getLeadNotSyncedData() as ArrayList<LeadLisDataItem>
                    )
                    model.data = list
                    model.error = false
                    liveData.postValue(model)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                try {
                    ...
                    orderList.addAll(
                        database!!.orderDao().getOrderNotSyncedData() as ArrayList<OrderData>
                    )
                    model.data = orderList
                    model.error = false
                    liveData.postValue(model)
    ...
    fun getOfflineCustomerFeedbackList(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                try {
                    ...
                    list.addAll(
                        database!!.customerDao()
                            .getCustomerFeedbackList(customerId) as ArrayList<CustomerFollowUpDataItem>
                    )
                    model.data = list
                    model.error = false
                    liveData.postValue(model)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                try {
                    ...
                    list.addAll(
                        database!!.expenseDao().getExpenseHeadNotSyncedData()
                                as ArrayList<ExpenseTrackerDataItem>
                    )
                    model.data = list
                    model.error = false
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                try {
                    ...
                    list.addAll(
                        database!!.expenseDao().getExpenseListNotSyncedData()
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                try {
                    ...
                    list.addAll(
                        database!!.dashboardDao().getBeatListData(value)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (database != null) {
                try {
                    ...
                    val boolean =
                        database!!.customerDao().getAttendanceData().isNullOrEmpty().not() ||
                                database!!.customerDao().getAllCustomerFeedbackList()
                                    .isNotEmpty() ||
                                ...
                                database!!.customerDao().getCustomerAddressNotSyncedData()
                                    .isNotEmpty() ||
                                database!!.expenseDao().getExpenseHeadNotSyncedData()
                                    .isNotEmpty() ||
    ...
    fun updateCustomerRelatedActivity(
        updateCustomerLiveData: MutableLiveData<GenericResponseModel>,
        oldCustomerId: Int,
        newCustomerId: Int
    ) {
        CoroutineScope(Dispatchers.IO).launch {
    ...
    fun updateAddressIdInOrders(
        updateAddressLiveData: MutableLiveData<GenericResponseModel>,
        oldAddressId: Int?,
        newAddressId: Int?
    ) {
        CoroutineScope(Dispatchers.IO).launch {
    ...
    fun updateExpenseHeadRelatedModel(
        updateExpenseLiveData: MutableLiveData<GenericResponseModel>,
        oldId: Int?,
        newId: Int?
    ) {
        CoroutineScope(Dispatchers.IO).launch {
    ...
    private fun updateAddressIdInJson(
        orderId: String?,
        address: Address?,
        oldAddressId: Int?,
        newAddressId: Int?
