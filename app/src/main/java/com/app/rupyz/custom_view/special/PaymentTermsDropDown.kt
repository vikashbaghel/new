...
class PaymentTermsDropDown : LinearLayoutCompat {
    ...
    private val itemAdapter: PaymentTermsAdapter = PaymentTermsAdapter()
    ...
    private inner class PaymentTermsAdapter :
        RecyclerView.Adapter<PaymentTermsAdapter.PaymentTermsViewHolder>() {

        private val originalStates = resources.getStringArray(R.array.payment_terms_new).toList()
        private val states = resources.getStringArray(R.array.payment_terms_new).toMutableList()
        private lateinit var onItemSelectListener: (Int, String) -> Unit

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PaymentTermsViewHolder {
            return PaymentTermsViewHolder(
        ...
        override fun onBindViewHolder(holder: PaymentTermsViewHolder, position: Int) {
            holder.bind(position, states[position].toString())
        }

        private inner class PaymentTermsViewHolder(itemView: ItemViewDropDownTextViewBinding) :
