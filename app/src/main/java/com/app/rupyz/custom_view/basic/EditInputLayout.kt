...
class EditInputLayout : TextInputLayout {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(
		    context, attrs, com.google.android.material.R.style.Widget_MaterialComponents_TextInputLayout_OutlinedBox_Dense
    ) {
        init(attrs)
    }

    constructor(context: Context) : super(
		    context, null, com.google.android.material.R.style.Widget_MaterialComponents_TextInputLayout_OutlinedBox_Dense
    ) {
        init(null)
    }
