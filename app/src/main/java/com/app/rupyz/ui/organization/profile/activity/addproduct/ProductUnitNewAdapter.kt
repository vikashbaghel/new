...
class ProductUnitNewAdapter(
    private var data: ArrayList<ProductUnitModel>,
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItem(model: ProductUnitModel, position: Int, onClickListener: OnClickListener) {
            binding.tvItems.text = model.name?.capitalize()
    ...
    class OnClickListener(val clickListener: (meme: ProductUnitModel) -> Unit) {
        fun onClick(meme: ProductUnitModel) = clickListener(meme)
    }
}