...
class SettingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.clCustomerLevel.setOnClickListener {
            ...
            binding.ivCustomerLevel.animate().rotation(rotationAngle.toFloat()).setDuration(300).start()
            ...
            if (data.error == false) {
                data.data?.let {
                    if (it.staffCustomerMapping != null) {
                        ...
                        binding.switchCategoryMapping.isChecked =
                            it.enableCustomerCategoryMapping ?: false
                        binding.switchSecondLevelOrdering.isChecked =
                            it.enableCustomerLevelOrder ?: false
                        ...
                        SharedPref.getInstance()
                            .putBoolean(STAFF_AND_CUSTOMER_MAPPING, it.staffCustomerMapping ?: true)
