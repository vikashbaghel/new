...
import com.app.rupyz.databinding.ItemDiscoveryAllBuisinessListBinding
import com.app.rupyz.generic.helper.StringHelper
import com.app.rupyz.generic.utils.ImageUtils
import com.app.rupyz.model_kt.OrgItem
import com.squareup.picasso.Picasso

class DiscoveryAllBusinessListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_discovery_all_buisiness_list, parent, false)
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val binding = ItemDiscoveryAllBuisinessListBinding.bind(itemView)
