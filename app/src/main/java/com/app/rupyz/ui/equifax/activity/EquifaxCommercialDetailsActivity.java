...
import com.app.rupyz.ui.equifax.fragment.EquifaxHomeDetailsFragment;
...
public class EquifaxCommercialDetailsActivity extends AppCompatActivity implements View.OnClickListener {

    private ActivityEquifaxCommercialDetailsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new FirebaseLogger(this).sendLog("Equifax Commercial Detail", "Equifax Commercial Detail");
        binding = ActivityEquifaxCommercialDetailsBinding.inflate(getLayoutInflater());
        ...
        binding.repaymentsOverdueLayout.btnOverdueDetails.setOnClickListener(this);
        binding.repaymentsOverdueLayout.btnMissedRepaymentDetails.setOnClickListener(this);
        ...
        binding.negativeNpaLayout.btnNpaDetails.setOnClickListener(this);
        binding.negativeNpaLayout.btnNegativeAccountDetails.setOnClickListener(this);
    ...
    private void intiRiskSlider() {
        ScorePagerAdapter adapter = new ScorePagerAdapter(getSupportFragmentManager(),
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.overdue_root_layout:
                initMyAccount(1);
                break;
            case R.id.btn_overdue_details:
                initMyAccount(1);
                break;
            case R.id.repayment_root_layout:
                initMyAccount(2);
                break;
            case R.id.btn_missed_repayment_details:
                initMyAccount(2);
                break;
            case R.id.btn_npa_details:
                initMyAccount(3);
                break;
            case R.id.btn_negative_account_details:
                initMyAccount(3);
                break;
...
//                navOwnershipMix();
            ...
            case R.id.btn_concern:
                new SessionHelper(this).messageToast("Our Expert will connect with you shorty.");
                break;
    ...
    private void initMyAccount(int index) {
        Gson gson = new Gson();
        Intent intent = new Intent(this, EquiFaxMyAccount.class);
    ...
    private void initScoreInsights() {
        ...
        binding.scoreInsights.negativeMessage.setText(
                new EquifaxScoreInsightsHelper().getNegativeMessage(this,
        ...
        binding.scoreInsights.repaymentMessage.setText(
                new EquifaxScoreInsightsHelper().setRepaymentStatus(this, (mData.getReport().getRepaymentsTotalCount() -
        ...
        new EquifaxScoreInsightsHelper().setCreditCardStatus(this, mData.getReport().getTradelines());


        //Credit Age data binding & calculation
        binding.scoreInsights.creditAgeMessage.setText(
                new EquifaxScoreInsightsHelper().setCreditAgeStatus(this, mData.getReport().getCreditAge()));


        //New Loan & New Inquiries in last 12 months data binding & calculation

        if (mData.getReport().getTradelines() != null) {
            binding.scoreInsights.loanMessage.setText(new EquifaxScoreInsightsHelper().setLoanStatus(this,
        ...
        try {
            binding.scoreInsights.businessVintageMessage.setText(
                    new EquifaxScoreInsightsHelper().setBusinessVintage(this, mData.getReport().getIncorporation_date(),
        ...
        binding.scoreInsights.loanCountMessage.setText(
                new EquifaxScoreInsightsHelper().setLoanType(this,
    ...
    private void commercialEMIDetails(EquiFaxInfoModel equiFaxInfoModel) {
                ...
                if (response.code() == 200) {
                    ...
                    if (response1.getData().size() > 0) {
                        for (Datum Item : response1.getData()) {
                            for (TradelinesItem tradelinesItem : equiFaxInfoModel.getReport().getTradelines()) {
