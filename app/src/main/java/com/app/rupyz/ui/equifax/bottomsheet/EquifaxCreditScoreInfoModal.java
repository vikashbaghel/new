...
public class EquifaxCreditScoreInfoModal extends BottomSheetDialogFragment {
    EquifaxCreditScoreInfoSheetBinding binding;
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        //Set the custom view
        binding = EquifaxCreditScoreInfoSheetBinding.inflate(getLayoutInflater());
        try {
            binding.btnClose.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    EquifaxCreditScoreInfoModal.this.dismiss();
                }
            });
        } catch (Exception ex) {
