package com.app.rupyz.ui.home.activity;
...
import com.app.rupyz.databinding.ActivityHomeDetailBinding;
    ...
    public void onClick(View v)  {
        switch (v.getId()) {
            ...
            case R.id.btn_concern:
                new SessionHelper(HomeDetailActivity.this).messageToast("Our Expert will connect with you shorty.");
                break;
            case R.id.dashboard_risk_layout:
                new SessionHelper(HomeDetailActivity.this).messageToast("A");
                break;
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.code() == 200) {
                    ...
                    try {
                        ...
                        new SessionHelper(HomeDetailActivity.this).requestErrorMessage(
                                responseBody,
