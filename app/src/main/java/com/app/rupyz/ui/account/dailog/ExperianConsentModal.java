...
public class ExperianConsentModal extends BottomSheetDialogFragment {

    private ImageButton mClose;
    ExperianConsentSheetBinding binding;
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        //Set the custom view
        binding = ExperianConsentSheetBinding.inflate(getLayoutInflater());
        try {
            binding.btnClose.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ExperianConsentModal.this.dismiss();
                }
            });
        } catch (Exception ex) {
