...
public class  ScoreInsightInfoModal extends BottomSheetDialogFragment {

    ScoreInsightsInfoSheetBinding binding;
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        //Set the custom view
        binding = ScoreInsightsInfoSheetBinding.inflate(getLayoutInflater());
        ...
        binding.scoreInsightsGraph.setDrawHoleEnabled(true);
        binding.scoreInsightsGraph.setHoleColor(Color.TRANSPARENT);
        binding.scoreInsightsGraph.setHoleRadius(60);
        ...
        try {
            binding.btnClose.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ScoreInsightInfoModal.this.dismiss();
                }
            });
        } catch (Exception ex) {
