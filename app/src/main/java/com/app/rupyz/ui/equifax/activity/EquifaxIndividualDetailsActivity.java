...
import com.app.rupyz.databinding.ActivityEquifaxIndividualDetailsBinding;
...
public class EquifaxIndividualDetailsActivity extends AppCompatActivity implements View.OnClickListener {

    private ActivityEquifaxIndividualDetailsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new FirebaseLogger(this).sendLog("Home Fragment", "Home Fragment");
        binding = ActivityEquifaxIndividualDetailsBinding.inflate(getLayoutInflater());
    ...
    private void initScoreInsights() {
        ...
        new ScoreInsightsHelper().setNegativeStatus(mData.getReport().getNegative_accounts_count(), total_npa,
                ...
                binding.scoreInsights.imgNegative, binding.scoreInsights.txtNegativeStatus, this);
        ...
        new ScoreInsightsHelper().setRepaymentStatus(mData.getReport().getRepayments_total_count()
                ...
                binding.scoreInsights.repaymentMessage, this);
        ...
        new ScoreInsightsHelper().setCreditCardStatusEquiFax(mData.getReport().getTradelines(),
                ...
                binding.scoreInsights.creditCardMessage, this);
        ...
        new ScoreInsightsHelper().setCreditAgeStatus(mData.getReport().getCredit_age(),
                ...
                binding.scoreInsights.creditAgeMessage, this);
        ...
        new ScoreInsightsHelper().setLoanStatusEquiFax(mData.getReport().getTradelines(), mData.getReport().getEnq_past12months() + "",
                ...
                binding.scoreInsights.loanMessage, this);
        ...
        new ScoreInsightsHelper().setFacilityMixStatus(
                ...
                binding.scoreInsights.securedLoanMessage, this);
    ...
    private void navOwnershipMix() {
        Gson gson = new Gson();
        Intent intent = new Intent(this, OwnershipMixActivity.class);
    ...
    private void initMyAccount(int index) {
        Gson gson = new Gson();
        Intent intent = new Intent(this, EquiFaxIndividualMyAccount.class);
