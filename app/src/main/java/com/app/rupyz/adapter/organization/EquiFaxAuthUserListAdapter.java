...
public class EquiFaxAuthUserListAdapter extends RecyclerView.Adapter<EquiFaxAuthUserListAdapter.MyViewHolder> {
    ...
    public EquiFaxAuthUserListAdapter(Context mContext, List<String> mList, int type) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        holder.binding.txtGst.setText(mList.get(holder.getAdapterPosition()));
