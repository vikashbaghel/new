...
class ConfirmAddressActivity : BaseActivity(), AddressListAdapter.AddressListener {
    ...
    private fun initRecyclerView() {
        ...
        binding.rvAddressList.isNestedScrollingEnabled = false
    }
    ...
    @SuppressLint("NotifyDataSetChanged")
    override fun onSelectAddress(model: CustomerAddressDataItem, position: Int) {
...
//            )
    ...
    override fun onEditAddress(model: CustomerAddressDataItem, position: Int) {
        startActivity(
                Intent(
                        this,
                        AddNewAddressActivity::class.java
