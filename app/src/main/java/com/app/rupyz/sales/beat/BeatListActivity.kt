...
class BeatListActivity : BaseActivity(), BeatListAdapter.IBeatActionListener,
    SortByBottomSheetDialogFragment.ISortByCustomerListener, DeleteDialog.IOnClickListener,
            ...
            if (it.error == false) {
                ...
                if (it.data?.isUsed == true) {
                    if (it.message.isNullOrEmpty().not()) {
                        DeleteDialog.showDeleteDialog(this,beatList[deleteBeatPosition].id,true,resources.getString(R.string.delete_beat),it.message!!,this)

                    } else {
                        DeleteDialog.showDeleteDialog(this,beatList[deleteBeatPosition].id,true,resources.getString(R.string.delete_beat),resources.getString(R.string.delete_beat_message),this)
    ...
    override fun onDeleteBeat(position: Int, model: BeatListDataItem) {
        ...
        DeleteDialog.showDeleteDialog(this,model.id,false,resources.getString(R.string.delete_beat),resources.getString(R.string.delete_beat_message),this)
    }
    ...
    override fun onDelete(model: Any, position: Any) {
        ...
        jsonObject.addProperty("is_forced", position as Boolean)
        beatViewModel.deleteBeat(model as Int, jsonObject)
    }
}