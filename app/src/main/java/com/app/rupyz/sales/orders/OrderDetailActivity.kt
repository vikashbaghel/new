...
class OrderDetailActivity : BaseActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cartActivityResultLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result: ActivityResult ->
            isDataChange = result.resultCode == RESULT_OK
        }
        ...
        onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                if (intent.hasExtra(AppConstant.NOTIFICATION)) {
                    startActivity(Intent(this@OrderDetailActivity, SalesMainActivity::class.java))
    ...
    override fun onClick(view: View?) {
        ...
        when (view) {
            ...
            binding.ivEdit -> {
                ...
                cartActivityResultLauncher.launch(Intent(this, CartActivity::class.java)
