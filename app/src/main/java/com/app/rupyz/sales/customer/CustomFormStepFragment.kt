                    ...
                    if (isGSTCorrect) {
                        viewMap[AppConstant.SECTION_NAME_BUSINESS_NAME]?.let {
                            if (it is EditInputLayout) {
                                it.setValue(customerPanOrGstInfoModel.data?.name)
                            }
                        }
                        viewMap[AppConstant.SECTION_NAME_BUSINESS_OWNER_NAME]?.let {
                            if (it is EditInputLayout) {
                                it.setValue(customerPanOrGstInfoModel.data?.firstName + " " + customerPanOrGstInfoModel.data?.middleName + " " + customerPanOrGstInfoModel.data?.lastName)
                            }
                        }
