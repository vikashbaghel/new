    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItem(model: CartItem, position: Int) {
            ...
            if (model.gst != null) {
                ...
                binding.tvGst.text =
                    CalculatorHelper().convertCommaSeparatedAmount(model.gst_amount ?: 0.0, AppConstant.FOUR_DECIMAL_POINTS)
            }
                ...
                model.discount_details?.let {
                    if (it.type?.lowercase() == AppConstant.DISCOUNT_TYPE_OFFER_PRICE.lowercase()) {
                        ...
                        binding.tvDiscountAmount.text =
                            CalculatorHelper().convertCommaSeparatedAmount(it.value, AppConstant.FOUR_DECIMAL_POINTS)
                        ...
                        binding.hdDiscount.text = "Discount (${CalculatorHelper().calculateQuantity(it.value)}%)"
            ...
            if (model.packagingSize != null && model.qty != null) {
                binding.tvOrderQty.text = itemView.context.getString(
                    ...
                    CalculatorHelper().calculateQuantity(model.qty!! * model.packagingSize!!),
