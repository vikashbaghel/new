...
class ListOfStaffActivity : BaseActivity(), StaffActionListener, CategoryListener {
    ...
    private fun showDeleteDialog(model: StaffData, position: Int) {
        ...
        tvHeading.text = resources.getString(R.string.delete_staff)
        tvTitle.text = resources.getString(R.string.delete_staff_message)
