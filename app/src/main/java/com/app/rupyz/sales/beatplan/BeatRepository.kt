...
class BeatRepository {
    ...
    fun getOrgBeatList(
        ...
        val uploadCred: Call<OrgBeatListResponseModel> = if (pageSize == null) {
            RetrofitClient.apiInterface.getOrgBeatList(id, staffId, name, true, page, null, false, null)
        } else {
            RetrofitClient.apiInterface.getOrgBeatList(id, staffId, name, true, page, pageSize, true, offlineDataLastSyncedTime)
        }
    ...
    fun getCustomerBeatMapping(
        ...
        val uploadCred: Call<OrgBeatListResponseModel> =
                RetrofitClient.apiInterface.getCustomerBeatMapping(id,
