...
class StaffActivityViewModel : ViewModel() {
    ...
    var staffActivityRecordLiveData = MutableLiveData<CustomerFollowUpListResponseModel>()
    ...
    fun getStaffActivityRecordListing(dateRange: String, staffId: Int?, page: Int, pageOffset: Int) {
        StaffActivityRepository().getStaffActivityRecordListing(
            staffActivityRecordLiveData, dateRange, staffId, page, pageOffset
        )
    }
