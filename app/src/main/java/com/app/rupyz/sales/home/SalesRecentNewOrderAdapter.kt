...
import com.app.rupyz.databinding.ItemSaleRecentNOrderBinding
...
class SalesRecentNewOrderAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_sale_recent_n_order, parent, false)
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        OrderStatusByBottomSheetDialogFragment.IStatusListener {
        val binding = ItemSaleRecentNOrderBinding.bind(itemView)
        ...
        fun bindItem(
            ...
            hasInternetConnection: Boolean, fragmentManager: FragmentManager
        ) {
            model1 = model
            ...
            if (model.customer?.city.isNullOrEmpty().not()) {
