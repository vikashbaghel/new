...
class BeatViewModel : ViewModel() {
    ...
    fun getLeadListForBeat(beatId: Int, name: String, type: String, date: String?, page: Int) {
        viewModelScope.launch {
            BeatRepository().getLeadList(leadListLiveData, beatId, name, type, date, page)
        }
    }
    ...
    fun getBeatList(name: String, page: Int, isForFilter: Boolean) {
        viewModelScope.launch {
            BeatRepository().getBeatList(beatListLiveData, name, page, isForFilter)
        }
    }
