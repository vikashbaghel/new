...
//        )
    ...
    private fun initRecyclerview() {
        ...
        teamTrackingListAdapter = TeamTrackingListAdapter(activityList, this, false)
    ...
    override fun getStaffInfo(model: StaffTrackingActivityModules) {
        startActivity(
            Intent(requireContext(), FragmentContainerActivity::class.java)
                    .putExtra(AppConstant.STAFF_ID, model.staffId)
                    .putExtra(AppConstant.DATE_FILTER, filterDate)
                    .putExtra(AppConstant.STAFF_NAME, model.staffName)
        )
    }
