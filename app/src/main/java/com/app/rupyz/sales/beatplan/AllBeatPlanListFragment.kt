...
class AllBeatPlanListFragment : BaseFragment(), RecyclerTouchListener.ClickListener {
            ...
            if (it.error == false) {
                it.data?.let { model ->
                    if (model.isUsed == true) {
                        showDeleteDialog(true, "${it.message}", deleteBeatPlanModel)
                    } else {
                ...
                popup.setOnMenuItemClickListener { item: MenuItem ->
                    when (item.itemId) {
                        ...
                        R.id.delete_product -> {
                            ...
                            showDeleteDialog(
                                false,
                                resources.getString(R.string.delete_beat_plan_message),
                                deleteBeatPlanModel
                            )
