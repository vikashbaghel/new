...
public class NavigationActivity extends BaseActivity {
    ...
    private void initNavigationView() {
        ...
        binding.navList.addOnItemTouchListener(new RecyclerTouchListener(this, binding.navList, (view, position) -> {
            switch (position) {
                case 0:
                    ...
                    break;
                case 1:
                    startActivity(new Intent(this, PictureGalleryActivity.class).putExtra(AppConstant.USER_PREFERENCE, true));
                    break;
                case 2:
        ...
        mAdapter = new NavigationViewAdapter(new NavigationViewData().
