...
class CustomerFilterActivity : BaseActivity() {
    ...
    fun changeFilterType(type : CustomerFilterType) {
        when(type){
            BEAT           -> {
    ...
    fun setBeadListAdapter(clearAdapter : Boolean,items : MutableList<BeatListDataItem>) {
        if (clearAdapter){
    ...
    fun setCustomerTypeSpinnerItems(clearAdapter : Boolean, list : MutableList<String>) {
        if (clearAdapter){
    ...
    fun setStaffAdapter(clearAdapter : Boolean, list : MutableList<StaffData>) {
        if (clearAdapter){
    ...
    fun setCustomerLevelAdapter(clearAdapter : Boolean, list : MutableList<Pair<String, String>>) {
        if (clearAdapter){
