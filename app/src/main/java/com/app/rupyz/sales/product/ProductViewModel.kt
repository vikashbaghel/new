...
class ProductViewModel : ViewModel() {
    ...
    fun getAllCategoryListWithCustomer(customerId: Int, name: String, headers: String?,
                                       hasInternet: Boolean) {
        viewModelScope.launch {
            if (hasInternet) {
    ...
    fun getProductDetails(id: Int, hasInternetConnection: Boolean) {
        viewModelScope.launch {
            if (hasInternetConnection) {
                repository.getProductDetails(productDetailsLiveData, id)
            } else {
    ...
    fun dumpOfflineCategoryList(
            page: Int,
            pageSize: Int,
            offlineDataLastSyncedTime: String?
    ) {
        viewModelScope.launch {
            ProductRepository().getAllCategoryList(
                    productCategoryLiveData,
                    null,
                    "",
                    page,
