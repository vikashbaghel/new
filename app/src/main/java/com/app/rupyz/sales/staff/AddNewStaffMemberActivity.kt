...
class AddNewStaffMemberActivity : BaseActivity(),
    ...
    private fun initLayout() {
        ...
        binding.ivUnAssignManager.setOnClickListener {
            assignedManagerId = -1
            binding.tvAssignedManager.text = ""
            binding.ivUnAssignManager.hideView()
        }
            ...
            data.data?.let { it ->
                if (!it.mobile.isNullOrEmpty()) {
                    ...
                    if (staffData.parent != null) {
                        ...
                        binding.ivUnAssignManager.showView()
